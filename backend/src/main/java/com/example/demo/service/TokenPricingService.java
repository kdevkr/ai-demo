...
public class TokenPricingService {
    ...
    static {
        MODEL_PRICES.put("gpt-5.1", new TokenPrice(0.000003, 0.000015));
        ...
        MODEL_PRICES.put("claude-haiku-4-5-20251001", new TokenPrice(0.00000025, 0.00000125));
        ...
        MODEL_PRICES.put("gemini-3-pro-preview", new TokenPrice(0.000001, 0.000005));
        MODEL_PRICES.put("gemini-2.5-flash", new TokenPrice(0.00000015, 0.0000006));
        MODEL_PRICES.put("gemini-2.5-flash-lite", new TokenPrice(0.00000005, 0.0000002));
    }
